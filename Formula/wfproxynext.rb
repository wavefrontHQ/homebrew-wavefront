...
class Wfproxynext < Formula
  ...
  url "http://wavefront-cdn.s3-website-us-west-2.amazonaws.com/brew/wfproxy-4.39.0.tar.gz"
  sha256 "f9398841402f3dda046b6126770a167ffdecd1195084ba0f0a6f5d1f61736b9b"
